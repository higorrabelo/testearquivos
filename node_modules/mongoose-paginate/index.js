 ...
 * @param {Array|Object|String}   [options.deepPopulate] //modificado
...
function paginate(query, options, callback) {
    ...
    var deepPopulate   = options.deepPopulate;
    ...
    if (limit) {
        ...
        //biblioteca modificada para aceitar deepPopulate
        if (deepPopulate) {
            query.deepPopulate([].concat(deepPopulate));
        }
